...
MEASURES = ("NOM10", "REAL10", "BE10")   # lote 3B (B3-1): una revisión de REAL10/BE10 con NOM10 igual también cuenta
...
def publish_result(result):
    ...
    return datestr, ctx.publish(name, data, revision_window=1,
                      measures=MEASURES)   # B3-1: la observación son las tres medidas
