...
# v2.5.1 (auditoría 24-sep-2026): la §05 del navegador descuenta una unión de festivos G8 y este DQM no, así que
# el brief marcaba STALE lo que la §05 daba LIVE (p.ej. TONA en la Silver Week japonesa 21-23 sep). Misma unión.
G8_HOLIDAYS = {
    "2026-01-01", "2026-01-19", "2026-02-16", "2026-04-03", "2026-04-06", "2026-05-04", "2026-05-25", "2026-06-19",
    "2026-07-03", "2026-08-03", "2026-08-31", "2026-09-07", "2026-10-12", "2026-11-11", "2026-11-26", "2026-12-25",
    "2026-12-28", "2026-01-12", "2026-02-11", "2026-02-23", "2026-03-20", "2026-04-29", "2026-05-05", "2026-05-06",
    "2026-07-20", "2026-09-21", "2026-09-22", "2026-09-23", "2026-11-03", "2026-11-23",
    "2027-01-01", "2027-01-18", "2027-02-15", "2027-03-26", "2027-03-29", "2027-05-03", "2027-05-31", "2027-06-18",
    "2027-07-05", "2027-08-02", "2027-08-30", "2027-09-06", "2027-10-11", "2027-11-11", "2027-11-25", "2027-12-27",
    "2027-12-28", "2027-01-11", "2027-02-11", "2027-02-23", "2027-03-22", "2027-04-29", "2027-05-04", "2027-05-05",
    "2027-07-19", "2027-09-20", "2027-09-23", "2027-11-03", "2027-11-23",
}
...
def bdays_between(d0, d1):
    ...
    while d < d1:
        d += timedelta(days=1)
        if d.weekday() < 5 and d.isoformat() not in G8_HOLIDAYS:
            n += 1
    return n
